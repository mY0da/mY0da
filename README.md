...
<h3 align="center">I'm a backend developer, passionate about</h3>
...
`class Profile
  def Information
    ...
    @education = "Le Wagon Lisbon, a 9-week full-time intensive coding bootcamp",
    @areasOfInterest = ["Ruby", "Python", "SQL"],
    @currentlylearning: ["Ruby on Rails", "JavaScript ES6", "SQL"],
    @technologies: ["Visual Studio Code", "Bootstrap", "Figma", "GitHub", "Heroku", "Wordpress"],
  end
end`
